...
msp.add_line((XD+2*F,YC+3.5*F),(CYX+1*F,YC+3.5*F),dxfattribs=E); msp.add_line((XD+2*F,YC+5.5*F),(CYX+1*F,YC+5.5*F),dxfattribs=E)
...
msp.add_line((CYX+1.5*F,EY(6.5)),(XD+8*F,EY(6.5)),dxfattribs=E); msp.add_line((CYX+1.5*F,EY(5.5)),(XD+8*F,EY(5.5)),dxfattribs=E)
rect(XD+2*F,EY(DBT-0.5),4*F,1.5*F,'EQUIPMENT'); msp.add_line((XD+2*F,EY(DBT+1)),(XD+2*F,EY(20.5)),dxfattribs=E); msp.add_line((XD+6*F,EY(DBT+1)),(XD+6*F,EY(21.5)),dxfattribs=E)
msp.add_line((XD+2*F,EY(20.5)),(CYX+CYR,EY(20.5)),dxfattribs=E); msp.add_line((XD+6*F,EY(21.5)),(CYX+CYR,EY(21.5)),dxfattribs=E)
...
leader(XD+4*F,EY(DBT+1.5),XD+10*F,EY(27),['DRYER EXHAUST DUCT']); leader(XD+STA['DB'][1]/2,EY(DBT-3),XD+STA['DB'][1]+3*F,EY(DBT+4),['DROP-OUT BOX'])
